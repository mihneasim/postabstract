...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogPost.abstract'
        db.add_column('blog_blogpost', 'abstract',
                      self.gf('mezzanine.core.fields.RichTextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogPost.abstract'
        db.delete_column('blog_blogpost', 'abstract')
    ...
    models = {
        ...
        'blog.blogpost': {
            ...
            'abstract': ('mezzanine.core.fields.RichTextField', [], {'default': "''"}),
